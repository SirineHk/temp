...
//Courses
import { AppproduitsComponent } from './produits/produits.component';
import { AppproduitDetailComponent } from './produits/produit-detail/produit-detail.component';
...
//Invoice
import { AppInvoiceDialogContentComponent, AppInvoiceListComponent } from './invoice/invoice-list/invoice-list.component';
...
@NgModule({
  ...
  exports: [TablerIconsModule,AppInvoiceDialogContentComponent],
  declarations: [
    AppChatComponent,
    ...
    ListingDialogDataExampleDialogComponent,
    ListingComponent,
    AppInvoiceDialogContentComponent,
    DetailComponent,
    AppEmailComponent,
    ...
    AppproduitsComponent,
    AppproduitDetailComponent,
...
export class AppInvoiceDialogContentModule { }
